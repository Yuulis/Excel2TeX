...
1. **Researcher** -- Uses WebSearch/WebFetch for external research (Opus 1M context)
   ...
   Save all findings to .Codex/docs/research/spike-{topic}-research.md
...
2. **Feasibility Analyst** -- Uses Codex CLI as PRIMARY analysis engine for technical feasibility
   ...
   - Place prototype in .Codex/spikes/{topic}/ directory
   Output format:
   ## What Was Tested
   ...
   Save analysis to .Codex/docs/research/spike-{topic}-feasibility.md
   ...
   IMPORTANT -- Work Log:
   When ALL your tasks are complete, write a work log file to:
     .Codex/logs/agent-teams/{team-name}/feasibility-analyst.md
...
- `.Codex/docs/research/spike-{topic}-research.md` -- Researcher findings
- `.Codex/docs/research/spike-{topic}-feasibility.md` -- Feasibility analysis (Codex-driven)
- `.Codex/spikes/{topic}/` -- Prototype code and results (if PROTOTYPE mode)
...
Save the complete spike report to `.Codex/docs/research/spike-{topic}.md`:
...
---
Full report saved to: `.Codex/docs/research/spike-{topic}.md`
...
| File | Author | Purpose |
|------|--------|---------|
| `.Codex/docs/research/spike-{topic}-research.md` | Researcher | External research findings |
| `.Codex/docs/research/spike-{topic}-feasibility.md` | Feasibility Analyst | Technical feasibility analysis (Codex-driven) |
| `.Codex/docs/research/spike-{topic}.md` | Lead | Final spike report (decision document) |
| `.Codex/spikes/{topic}/` | Feasibility Analyst | Prototype code (PROTOTYPE mode only) |
...
- **PROTOTYPE mode**: Prototype code is throwaway. It lives in `.Codex/spikes/` and is NOT production code. Its only purpose is to generate evidence for the decision
...
- **Reuse research**: Spike reports in `.Codex/docs/research/` persist across sessions. Reference prior spikes before starting new ones on similar topics
