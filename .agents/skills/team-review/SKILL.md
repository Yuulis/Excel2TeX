...
- **`.Codex/docs/DESIGN.md`** — architecture and design decisions to check the implementation against
...
1. **Security Reviewer**
   ...
   Reference: .Codex/rules/security.md
   ...
   Save report to .Codex/docs/research/review-security-{feature}.md

   IMPORTANT — Work Log:
   When your review is complete, write a work log file to:
     .Codex/logs/agent-teams/{team-name}/security-reviewer.md
...
2. **Quality Reviewer**
   ...
   - Adherence to coding principles (.Codex/rules/coding-principles.md)
   ...
   - Library constraint violations (.Codex/docs/libraries/)
   ...
   Save report to .Codex/docs/research/review-quality-{feature}.md

   IMPORTANT — Work Log:
   When your review is complete, write a work log file to:
     .Codex/logs/agent-teams/{team-name}/quality-reviewer.md
...
3. **Test Reviewer**
   ...
   Reference: .Codex/rules/testing.md
   ...
   Save report to .Codex/docs/research/review-tests-{feature}.md

   IMPORTANT — Work Log:
   When your review is complete, write a work log file to:
     .Codex/logs/agent-teams/{team-name}/test-reviewer.md
...
Read review reports:
- `.Codex/docs/research/review-security-{feature}.md`
- `.Codex/docs/research/review-quality-{feature}.md`
- `.Codex/docs/research/review-tests-{feature}.md`
...
- **Report persistence**: Save review results in `.Codex/docs/research/` for reference during fixes
