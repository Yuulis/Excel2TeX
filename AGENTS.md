...
- Document map: `AGENTS.md` = orchestrator contract; `.Codex/docs/DESIGN.md` = 要件定義書 (macro requirements/design); `PROGRESS.md` = micro work progress (latest 5 checkpoints).
